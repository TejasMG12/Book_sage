...
sign_up.addEventListener("click", function () {
  ...
  if (!pass_pattern.test(password)) {
    notify(
      "error",
      "Weak Password!",
      "Password must contain at least one special, one upper, one lower and special char"
    );
...
function notify(type, title, message) {
  ...
  switch (toast_type) {
    ...
    default:
      toast_icon =
        '<i style="width:35px;height:35px" class="fas fa-' +
        toast_type +
        '"></i>';
  }
  ...
  $("<div>", {
    ...
    .html(
      '<div class="toast-content"><div class="toast-icon">' +
        toast_icon +
        '</div><div class="toast-body"><strong>' +
        toast_title +
        "</strong><div>" +
        toast_message +
...
document
  ...
  .addEventListener("click", function (e) {
    ...
    const type =
      sign_in_psw.getAttribute("type") === "password" ? "text" : "password";
...
document
  ...
  .addEventListener("click", function (e) {
    // toggle the type attribute
    const type =
      sign_up_psw.getAttribute("type") === "password" ? "text" : "password";
